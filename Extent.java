...
public class Extent {
	...
	public Extent(double x, double y, double height, double width) {
		this.x = x;
		this.y = y;
		this.height = height;
		this.width = width;
	...
	/** Returns the length from the center of an object's extent to the right edge of its extent. */
	...
	/** detects overlap between circle and rectangle */
